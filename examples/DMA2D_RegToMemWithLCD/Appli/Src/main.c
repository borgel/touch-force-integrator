...
#define LAYER_SIZE_X DISPLAY_WIDTH_PX
#define LAYER_SIZE_Y DISPLAY_HEIGHT_PX
...
//  MX_LTDC_Init();
  ...
  // TODO what is the instance param?
  BSP_LCD_Init(0, 0);
  /* USER CODE BEGIN 2 */
...
//   }
  ...
  // precompute shapes which we will DMA on screen later
  // cross (to use to show a finger)
  {
    //
  }
